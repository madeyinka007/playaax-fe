...
const Authors = () => {
  ...
  const { authors, author, loading, error } = useSelector(
    (state) => state.author
  );
  ...
  const tableHeader = {
    tableHeadings: ["S/N", "Full Name", "Profile", "Image", "Status"],
  };
  ...
  return (
    <>
        ...
        <div className=" flex items-center justify-between ">
          <div className="pb-4 pt-1">
            ...
            <h5 className="text-gray-500 text-sm font-normal max-w-lg">
              Add authors to posts on the front end and enhance post for a
        ...
        <div className="border border-gray-200 rounded-xl ">
          <div className="flex items-center justify-between p-4 rounded-t-xl border-b bg-white">
            <div className="font-normal text-gray-600 text-xs">
              ...
              {authors?.response?.length} authors
            </div>
      ...
      {openCreateAuthor && (
        <AddAuthorModal setOpenModal={setOpenCreateAuthor} />
      )}
